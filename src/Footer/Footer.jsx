const Footer = ()=>{
    return(
<footer class="bg-gray-800 dark:bg-gray-800"id="other">
      ...
      <div class="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
        <div class="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
          ...
          <div>
            ...
            <ul class="space-y-3">
              ...
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Become a developer</a>
              </li>
              <li>
          ...
          <div>
            <h6 class="mb-4 text-sm font-semibold uppercase text-gray-900 dark:text-white">Duocortex App</h6>
            <ul class="space-y-3">
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">What is DuoCorte?</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">How It Works</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Safety</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Guarantee</a>
              </li>
              <li>
          ...
          <div>
            <h6 class="mb-4 text-sm font-semibold uppercase text-gray-900 dark:text-white">Chat on DuoCortex</h6>
            <ul class="space-y-3">
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Registration</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">How to Start</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">User Policies</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Resources</a>
              </li>
              <li>
                <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">User Support</a>
              </li>
            </ul>
          </div>
        ...
        <div class="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
          <div class="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
            ...
            <div>
              <p class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Chat on the  <a href="#" title="" class="underline hover:no-underline">DuoCortex App</a></p>
    ...
    <div class="py-6 md:py-8">
      <div class="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
        <a href="#" title="" class="block">
          <img class="block h-8 w-auto dark:hidden" src="" alt="" />
          <img class="hidden h-8 w-auto dark:block" src="" alt="" />
        </a>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">© 2024 <a href="#" class="hover:underline">DuoCortex</a>, Inc. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
